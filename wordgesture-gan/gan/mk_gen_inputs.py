...
def save_processed_data(all_real_data, all_z, all_generator_inputs, save_dir='processed_test_data'):
    # ディレクトリが存在しない場合は作成
...
def main():
    # データセットの作成
    csv_folder_path = '/home/rsato/.vscode-server/data/User/globalStorage/wordgesture-gan/datasets/datasets_per_word/test_datasets_formatted'
    # 訓練データセットの単語リストを読み込む
