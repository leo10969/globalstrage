...
def train_model(generator, discriminator, train_dataset, num_epoch, device, batch_size): 
    ...
    print("Training Done!")
    # 生成器と識別器を保存
    generator.save('gan_tutorial/modelfolder')
    discriminator.save('gan_tutorial/modelfolder')
...
# train_model関数の呼び出し
G_update, D_update = train_model(generator, discriminator, train_dataset, 20, device, batch_size)
